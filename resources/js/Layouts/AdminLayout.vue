            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <!-- Admin Menu Items -->
                                <NavLink :href="route('admin.profile.index')" :active="route().current('admin.profile.*')">
                                    Profile
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('admin.profile.index')" :active="route().current('admin.profile.*')">
                            Profile
                        </ResponsiveNavLink>
